...
### Acknowledgement: We thank the authors of [CoOp/CoCoOp](https://github.com/KaiyangZhou/CoOp/blob/main/DATASETS.md#how-to-install-datasets) for their foundational work in providing dataset preparation guidelines. Our project builds upon their format, with adaptations made to meet our specific requirements.
